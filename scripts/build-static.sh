...
# Excalidraw Recording - Static Build & Deploy Script
# https://github.com/encoreshao/excalidraw-recording
#
# Usage:
...
#   ./scripts/build-static.sh --zip                        # Build and create ZIP archive
#   ./scripts/build-static.sh --tar                        # Build and create TAR archive
...
echo ""
echo "=========================================="
echo "  Excalidraw Recording - Static Build"
echo "  github.com/encoreshao/excalidraw-recording"
echo "=========================================="
echo ""
...
# Step 4: Upload / archive if requested
if [[ "$1" == "--upload" ]] || [[ "$1" == "-u" ]]; then
    ...
    ZIP_FILE="$PROJECT_ROOT/excalidraw-recording-static.zip"
    ...
    TAR_FILE="$PROJECT_ROOT/excalidraw-recording-static.tar.gz"
...
echo ""
log_info "Next steps:"
echo "  1. Upload files:  ./scripts/build-static.sh --upload user@server:/var/www/html/"
echo "  2. Or use rsync:  ./scripts/build-static.sh --rsync user@server:/var/www/html/"
echo "  3. Or create ZIP:  ./scripts/build-static.sh --zip"
echo "  4. Or create TAR:  ./scripts/build-static.sh --tar"
echo ""
